...
/*
Next, it would be great to see a similar monthly trend for Gsearch, but this time splitting out nonbrand 
and brand campaigns separately.
*/ 
...
/*
For the gsearch lander test, estimate the revenue that test earned us 
...
/*
For the landing page test analyzed previously, it would be great to show a full conversion funnel 
...
/*
analyze the lift generated from the test (Sep 10 – Nov 10), in terms of revenue per billing page session, and then pull the number 
